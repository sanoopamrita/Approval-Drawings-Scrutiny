  ...
  return (
    <div className="space-y-6 animate-fadeIn font-sans">
      ...
      >
        ...
        {/* Section 5: Statutory Legal Disclaimer */}
        <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-[10.5px] leading-relaxed text-slate-600 space-y-1.5">
          <div className="flex items-center gap-1.5 font-bold text-slate-800 text-[11px]">
            <ShieldCheck className="w-4 h-4 text-emerald-600 shrink-0" />
            <span>{isMl ? 'സ്റ്റാറ്റ്യൂട്ടറി സാങ്കേതിക അറിയിപ്പ് (Statutory Disclaimer)' : 'Statutory Compliance & Liability Disclaimer'}</span>
          </div>
          <p>
            {isMl
              ? 'ഈ റിപ്പോർട്ട് കേരള മുനിസിപ്പാലിറ്റി കെട്ടിട നിർമ്മാണ ചട്ടങ്ങൾ (KMBR 2019) / കേരള പഞ്ചായത്ത് കെട്ടിട നിർമ്മാണ ചട്ടങ്ങൾ (KPBR 2019), കെ-സ്മാർട്ട് (K-Smart) വിജ്ഞാപനങ്ങൾ എന്നിവ അടിസ്ഥാനമാക്കി സ്വമേധയാ തയ്യാറാക്കപ്പെട്ട കമ്പ്യൂട്ടറൈസ്ഡ് സാങ്കേതിക പരിശോധനയാണ്. ഇത് ഔദ്യോഗിക എൻജിനീയറിംഗ് പരിശോധനകൾക്കും K-Smart പെർമിറ്റ് അനുമതിക്കും മുന്നോടിയായുള്ള പ്രീ-ചെക്കിംഗിനായി ഉപയോഗിക്കാവുന്നതാണ്.'
              : 'This technical scrutiny report is generated by VINYASA automated compliance intelligence based on Kerala Municipality Building Rules (KMBR 2019) / Kerala Panchayat Building Rules (KPBR 2019) and LSGD gazette notifications. This report serves as pre-submission technical verification for registered architects/engineers prior to formal K-Smart approval.'}
          </p>
        </div>
